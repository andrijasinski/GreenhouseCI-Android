...
APK_PATH = 'build/outputs/apk/GreenhouseCI-flavor1-debug.apk'
...
module Application
  module Android
    ...
    Appium.promote_singleton_appium_methods Application

    screenshot 'screen.png'
    puts 'Screenshot saved to screen.png'
    puts default_wait
    ...
    tvs = texts
    raise unless tvs.length == 2

    tvs.each do |textview|
      puts textview.text
    end
